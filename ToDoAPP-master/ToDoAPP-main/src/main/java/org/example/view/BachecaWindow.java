...
public class BachecaWindow {
    ...
    /** Pannello contenitore che ospita tutte le bacheche */
    ...
    /** Campo di testo per cercare ToDo in base al titolo */
    private JTextField searchField;

    /** Campo di testo per inserire la data di scadenza da filtrare (formato: dd/MM/yyyy) */
    private JTextField dateField;

    /** Bottone per avviare la ricerca in base a titolo e data */
    private JButton searchButton;

    /** Bottone per mostrare solo i ToDo in scadenza oggi */
    private JButton todayButton;


    /**
     * Pannello contenitore aggiuntivo, eventualmente usato per layout interni
     * o future estensioni (attualmente non utilizzato direttamente).
     */
    private JPanel panelBachecheList;
    /**
     * Costruttore della finestra principale dell'applicazione.
     * Inizializza l'interfaccia grafica, imposta le azioni sui pulsanti
     * e carica le bacheche disponibili.
     */
    ...
    /**
     * Registra gli event listener per i pulsanti dell'interfaccia,
     * come logout, creazione bacheca e filtri di ricerca.
     */
    ...
    /**
     * Aggiorna la visualizzazione dinamica delle bacheche e dei rispettivi ToDo.
     *
     * @param searchQuery testo da cercare nei titoli dei ToDo (può essere null)
     * @param filterDate  data per filtrare i ToDo (può essere null)
     * @param onlyToday   true se si vogliono mostrare solo i ToDo in scadenza oggi
     */
    ...
    /**
     * Mostra un popup per visualizzare un'immagine associata a un ToDo.
     *
     ...
     * da utilizzare come contenuto nel frame principale dell'applicazione.
     *
     * @return pannello principale dell'interfaccia
     */
    public JPanel getPanel() {
        return mainPanel;
    }
    /**
     * Inizializza i componenti grafici dell'interfaccia utente.
     * Crea la barra superiore con filtri e comandi e imposta lo scroll delle bacheche.
     */
