            ...
            if (todos.isEmpty()) {
                ...
                for (ToDo todo : todos) {
                    ...
                    condividiBtn.addActionListener(e -> {
                        // Supponiamo che tu abbia un metodo che restituisce tutti gli utenti (escludendo l’autore)
                            ...
                            if (!utentiSelezionati.isEmpty()) {
                                for (String utente : utentiSelezionati) {
                                    if (!todo.getListaUtenti().contains(utente)) {
                                        todo.getListaUtenti().add(utente);
                                    }
                                }
                                JOptionPane.showMessageDialog(mainPanel, "ToDo condiviso con successo!", "Successo", JOptionPane.INFORMATION_MESSAGE);
                            }
                        }
                    });
