...
public class RichiestaDAO implements RichiestaDAOInterface {
    ...
    public List<String> getUtentiCondivisi(int todoId) throws SQLException {
        List<String> utenti = new ArrayList<>();
        String sql = "SELECT destinatario FROM richieste_todo WHERE id_todo = ? AND stato = 'accettata'";
